...
parties <<- list("republican",
                 "democrat")
#wordlecolor <<- list("Red", "Blue")
#shapes <<- list("pics/republican_symbol.png", "pics/democratic_symbol.png")

getData <- memoise(function(party) {
  mydata <- filter(wordclouds, parties==party, n>1)
  mydata <- mydata[,-1]
})